import pytest
from src.data_overview_002 import analyze_data
import pandas as pd
import sqlite3
from pathlib import Path
import matplotlib.pyplot as plt

class TestDataOverview002:
    def test_analyze_data_basic(self, temp_db):
        ...
        assert Path('data_overview_002.png').exists()
        assert Path('data_overview_002.txt').exists()
    ...
    def test_analyze_data_statistics(self, temp_db):
        ...
        with open('data_overview_002.txt', 'r') as f:
            content = f.read()
    ...
    def test_analyze_data_visualizations(self, temp_db):
        ...
        # Clean up
        Path('data_overview_002.png').unlink()
        Path('data_overview_002.txt').unlink()
